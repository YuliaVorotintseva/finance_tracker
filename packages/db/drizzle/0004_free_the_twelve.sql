...
ALTER TABLE "verificationToken" ADD COLUMN "token" text NOT NULL;--> statement-breakpoint
ALTER TABLE "verificationToken" ADD COLUMN "expires" timestamp NOT NULL;--> statement-breakpoint
...
ALTER TABLE "verificationToken" DROP COLUMN "id";--> statement-breakpoint
ALTER TABLE "verificationToken" DROP COLUMN "value";--> statement-breakpoint
